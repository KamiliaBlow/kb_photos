...
CreateThread(function()
    ...
    PromptZoom = PromptRegisterBegin()
    
    PromptSetControlAction(PromptZoom, Config.ZoomPlusKey)
    PromptSetControlAction(PromptZoom, Config.ZoomMinusKey)
    
    PromptSetText(PromptZoom, CreateVarString(10, 'LITERAL_STRING', Config.LocaleZoom))
    PromptSetEnabled(PromptZoom, 0)
    PromptSetVisible(PromptZoom, 0)
    PromptSetStandardMode(PromptZoom, 1)
    PromptSetGroup(PromptZoom, PromptGroup)
    PromptRegisterEnd(PromptZoom)
        ...
        if targetUIState ~= currentUIState then
            ...
            if targetUIState == "active" then
                ...
                if activeCameraType == "ADVANCED" then
                    ...
                    PromptSetEnabled(PromptZoom, 1)
                    PromptSetVisible(PromptZoom, 1)
                else
                    PromptSetEnabled(PromptFx, 0)
                    PromptSetVisible(PromptFx, 0)
                    PromptSetEnabled(PromptZoom, 0)
